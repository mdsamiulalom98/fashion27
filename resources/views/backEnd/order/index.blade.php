            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <th style="width:9%">Courier ID</th>
                        ...
                        <tbody>
                            @foreach ($show_data as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                         @php
                                            $phoneCount = \App\Models\Shipping::where('phone', $value->shipping->phone)->count();
                                        @endphp
                                        
                                        <p class="repeat__customer">{{ $value->shipping ? $value->shipping->phone : '' }}
                                        @if($phoneCount > 1)
                                           <i class="fe-check" title="Repeat Customer" ></i>
                                        @endif</p>
                                        <button class="fraud_checker btn btn-xs rounded-pill btn-primary" data-id="{{$value->id }}" data-bs-toggle="modal" data-bs-target="#fraud_checker_modal">Check Fraud</button>
                                    </td>
