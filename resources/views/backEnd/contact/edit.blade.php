                        ...
                        <form action="{{ route('contact.update') }}" method="POST" class="row" data-parsley-validate=""
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('imo') is-invalid @enderror"
                                        name="imo" value="{{ $edit_data->imo }}" id="imo">
                                    @error('imo')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('bkash') is-invalid @enderror"
                                        name="bkash" value="{{ $edit_data->bkash }}" id="bkash">
                                    @error('bkash')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nagad') is-invalid @enderror"
                                        name="nagad" value="{{ $edit_data->nagad }}" id="nagad">
                                    @error('nagad')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
